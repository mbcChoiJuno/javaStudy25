 ...
 */
 ...
 /*
     ...
     A 사용자가 의도한대로 동작을 성공했다면  COMMIT으로  실제 테이블객체에  변경사항을 반영해주면  트렌젝션이 풀리고 다른 사용자도 제어할 수 있음
     
     A 사용자가 의도한대로 동작하지 않으면   ROLLBACK을 통해  제어문 사용 자체를 취소시켜서  제어가 시작되기 이전상태로 트렌젝션이 풀리고 다른 사용자도 제어할 수 있음
 */
